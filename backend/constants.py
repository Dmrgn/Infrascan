...
BUSINESS_SEARCH_RADIUS = 1000 # distance the gmaps api will search for businesses in meters
...
Here is an example:
Given the data segment "[school] Cedarvale Community School is 0.23049585663757122 kilometers away with a user rating of 3 and a community score of 13.015418340977652. It is listed as being a: primary_school,school,point_of_interest,establishment,."
An appropriate response might be: "[school] Cedarvale Community School is within close proximity at just 200 meters away. With a predicted community score of 13, this school greatly contributes to the community landscape of the neighbourhood."
